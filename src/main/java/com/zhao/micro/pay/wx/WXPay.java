...
//        }
    ...
    public Map<String, String> fillRequestData(Map<String, String> reqData) throws Exception {
        ...
        // ============================================
        String signTypeStr = reqData.get("sign_type");
        if (signTypeStr != null) {
            if (MyWXPayConfig.SignType_MD5.equalsIgnoreCase(signTypeStr)) {
                signType = SignType.MD5;
            } else if (MyWXPayConfig.SignType_HMACSHA256.equalsIgnoreCase(signTypeStr)) {
